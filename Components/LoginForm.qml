// Formulario de inicio de sesión que contiene el reloj, el campo de entrada y los botones del sistema
// Permite mostrar u ocultar el teclado virtual con animaciones suaves
import QtQuick 2.15
